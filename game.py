#Please note that the code will not run unless pygame is installed on the program that you use Doctor
#Ahmed Ayman elsayed Sallam 221001987, Alia Mostafa 221001994,Youssef Ahmed abdelaziz 221001862,CSC102,LEC-07,LAB-07A
